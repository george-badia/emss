...
import { QuickActions } from "../service-portal/quick-actions";
...
export default function MyAccount({ customer = false }: { customer?: boolean }) {
  ...
  return <main className={`account-layout${collapsed ? " sidebar-collapsed" : ""}`}>
    ...
    <div className="account-page">
      ...
      {isCustomerAccount && <QuickActions />}<footer className="account-footer"><a href="#terms">Terms of Service</a><span>and</span><a href="#privacy">Privacy Policy</a></footer><button className="account-chat" type="button" aria-label="Open support chat">?</button>
    </div>
  </main>;
}
